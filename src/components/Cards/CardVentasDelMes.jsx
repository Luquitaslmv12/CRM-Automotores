...
export default function CardVentasDelMes() {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-slate-800 to-slate-900 backdrop-blur-sm p-6 rounded-xl shadow-lg border-l-4 border-emerald-500 hover:shadow-emerald-500/10 transition-all h-full flex flex-col"
    >
