...
export default function CardEvolucionVentas() {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-slate-800 to-slate-900 backdrop-blur-sm p-6 rounded-xl shadow-lg flex flex-col gap-4 border-l-4 border-blue-500 hover:shadow-blue-500/10 transition-all"
    >
      {/* Encabezado */}
