...
export default function CardPresupuestosRecientes() {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-slate-700 to-slate-900 backdrop-blur-sm p-5 rounded-xl shadow-lg border-l-4 border-indigo-500 hover:shadow-indigo-500/10 transition-all min-h-80"
    >
