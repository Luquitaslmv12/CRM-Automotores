...
export default function CardVehiculosReparacion() {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-slate-700 to-slate-900 backdrop-blur-sm p-4 sm:p-6 rounded-xl shadow-lg border-l-4 border-indigo-500 hover:shadow-indigo-500/20 transition-shadow w-full min-h-80"
    >
